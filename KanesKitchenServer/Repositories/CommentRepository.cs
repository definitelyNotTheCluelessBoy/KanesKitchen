...
namespace KanesKitchenServer.Repositories
{
    public class CommentRepository : IComentRepository
    {
        ...
        public async Task<GeneralResponse> AddCommentAsync(Comment newComment)
        {
        ...
        public async Task<GeneralResponse> DeleteCommentAsync(int commentId)
        {
        ...
        public async Task<GeneralResponse> UpdateCommentAsync(int commentId, string content)
        {
            var comment = await _context.Comments.FindAsync(commentId);
